...
ROOT_URLCONF = "endless_storage.urls"
...
WSGI_APPLICATION = "endless_storage.wsgi.application"
...
REST_FRAMEWORK = {
    "EXCEPTION_HANDLER": "endless_storage.exceptions.handler.custom_exception_handler",
    "DEFAULT_RENDERER_CLASSES": ["endless_storage.response_renderer.CustomJsonRender"],
...
# Added these settings for better error reporting.
APPEND_SLASH = True
